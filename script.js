...
async function diagnose() {
  ...
  const sys =
    "あなたは経験豊富な手相診断士です。画像の手のひらを観察し、まず主要な線（生命線・知能線・感情線・運命線・太陽線など）と手の形を、粗いカテゴリ（例：長い/短い、濃い/薄い、まっすぐ/カーブ、あり/なし）で判定します。" +
    "そのうえで、判定した特徴だけを根拠に診断を導きます。創作で大きく飛躍させず、同じ特徴なら同じ診断になるようにしてください。手のひらがはっきり写っていない場合は ok:false を返します。";
  const user =
